...
/-- Sillari mixes a proof-theoretic account with eleven axioms B1 - B8 and 
    ...
    Axiom B3 contradicts the definitions: we provide a copunterexample.
...
/-- Lewis' axiom C4 fails. This proves that Sillari's formalisation does not match 
...
/-- option 1 : C1 - C3 are only assumed at the world for which the theorem has to 
    ...
    worlds. In this counterexaple, the frame is nor transitive nor serial. -/
